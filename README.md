...
![Total Cost](images/costo_totale_10_anni.png)

### Annual Operating Cost

![Annual Cost](images/costo_annuale.png)

> 📁 Images are generated by the Python script and saved in the `images/` folder.
